    ...
    return GetBuilder<EditPassViewModel>(builder: (controller) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: ColorUtils.kBlack,
          title:
              Text('Update Password', style: FontTextStyle.kWhite16BoldRoboto),
          centerTitle: true,
        ),
                            ...
                            children: [
                              ...
                              TextFormField(
                                  style: TextStyle(
                                      ...
                                      color: Colors.white,
                                      fontSize: Get.height * 0.018),
                                  obscureText: selectedNew ? false : true,
                                  controller: newPass,
                                  onTap: () {
                                    setState(() {
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(8),
                                      borderSide:
                                          !isNewPassEmpty && !isNewPassNotValid
                                              ? BorderSide.none
                                              : BorderSide(
                                                  color: Colors.red, width: 2),
                                    ),
                            ...
                            children: [
                              ...
                              TextFormField(
                                  style: TextStyle(
                                      ...
                                      color: Colors.white,
                                      fontSize: Get.height * 0.018),
                                  obscureText: selectedCNew ? false : true,
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            if (_formKeyEditPassword.currentState!.validate()) {
                              ...
                              _request.newPassword = newPass.text.trim();
                              _request.confirmPassword =
                                  confirmNewPass.text.trim();

                              await controller.editPassViewModel(_request);
