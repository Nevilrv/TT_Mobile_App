  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: ColorUtils.kBlack,
        title: Text('Comments', style: FontTextStyle.kWhite16BoldRoboto),
        centerTitle: true,
      ),
      body: Column(
        children: [
          GetBuilder<ForumViewModel>(builder: (controller) {
            if (controller.getAllCommentsApiResponse.status == Status.LOADING) {
              return Center(
                  child: Padding(
            ...
            if (controller.getAllCommentsApiResponse.status == Status.ERROR) {
              return Center(
                  child: Padding(
                padding: EdgeInsets.only(top: 20),
                child: Text(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: ColorUtils.kSaperatedGray.withOpacity(0.4),
                ...
                child: Padding(
                  ...
                  child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: controller.addCommentApiResponse.status ==
                                  Status.LOADING
