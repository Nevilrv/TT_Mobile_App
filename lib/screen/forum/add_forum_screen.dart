      ...
      return control.isOnline
          ? Scaffold(
              ...
              appBar: AppBar(
                ...
                backgroundColor: ColorUtils.kBlack,
                title:
                    Text('Add Post', style: FontTextStyle.kWhite16BoldRoboto),
                centerTitle: true,
              ),
              body: Stack(
                children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                    ...
                                    borderSide:
                                        BorderSide(color: ColorUtils.kTint)),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children:
                                        List.generate(filesAll.length, (index) {
                                ...
                                Container(
                                  child: Material(
                                    ...
                                    child: StatefulBuilder(
                                      ...
                                      setState(() {
                                        keybardHeight = MediaQuery.of(context)
                                            .viewInsets
                                            .bottom;
                                      });
                                          ...
                                          if (title.text.isEmpty) {
                                            ...
                                            for (int i = 0;
                                              ...
                                              if (filesAll[i] ==
                                                ...
                                                List<dio.MultipartFile>?
                                                    dataFile = [];
                                                for (int i = 0;
                                                    i < filesAll.length;
                                                    i++) {
                                                  dataFile.add(await dio
                                                          .MultipartFile
                                                      .fromFile(
                                                          filesAll[i]['file']
                                                              .path,
