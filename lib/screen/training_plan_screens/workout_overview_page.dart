  ...
  Widget build(BuildContext context) {
    return GetBuilder<ConnectivityCheckViewModel>(builder: (control) {
      return control.isOnline
          ? GetBuilder<DayBasedExerciseViewModel>(builder: (controller) {
                                ...
                                Column(
                                  children: [
                                    ...
                                    ListView.builder(
                                        ...
                                        physics: NeverScrollableScrollPhysics(),
                                        itemCount:
                                            response.data![0].exercises!.length,
                                        itemBuilder: (_, index) {
                                          // log('index1 ============== $index1');
                                                      ...
                                                      Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                              ...
                                                              image: DecorationImage(
                                                                  image: response.data![0].exercises![index].exerciseImage == null ||
                                                                          response
                                                                              .data![0]
                                                                              .exercises![index]
                                                                              .exerciseImage!
                                                                              .isEmpty
                                                                      ? NetworkImage('https://cdn.sanity.io/images/0vv8moc6/ophtalmology/d198c3b708a35d9adcfa0435ee12fe454db49662-640x400.png/no-image-available-icon-6.jpg?w=1500&fit=max&auto=format')
