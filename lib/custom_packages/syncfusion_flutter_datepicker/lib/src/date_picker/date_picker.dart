...
import 'package:tcm/custom_packages/syncfusion_flutter_core/lib/core.dart';
import 'package:tcm/custom_packages/syncfusion_flutter_core/lib/core_internal.dart';
import 'package:tcm/custom_packages/syncfusion_flutter_core/lib/localizations.dart';
import 'package:tcm/custom_packages/syncfusion_flutter_core/lib/theme.dart';
...
class _PickerHeaderViewState extends State<_PickerHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    double arrowSize = widget.height * 0.7;
